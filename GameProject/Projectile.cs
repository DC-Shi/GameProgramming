...
namespace GameProject
{
    ...
    public class Projectile
    {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (drawRectangle.Bottom < 0 || drawRectangle.Top > GameConstants.WindowHeight ||
                drawRectangle.Right < 0 || drawRectangle.Left > GameConstants.WindowWidth)  // we also check horizontal
                Active = false;
        }
