...
namespace ProgrammingAssignment3
{
    ...
    public class Rock
    {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            // We must check 4 conditions, if any one matches, the rock is outside window
            if ( drawRectangle.X < -this.sprite.Width    // right of rock is outside left
            || drawRectangle.Y < -this.sprite.Height  // bottom of rock is outside top
            || drawRectangle.Y > windowHeight    // top of rock is outside bottom
            || drawRectangle.X > windowWidth    // left of rock is outside right
            )
                outsideWindow = true;
